...
class ProdutoService {
    ...
    async getSazonalidade(periodo = 'ano-atual') {
        const sazonalidade = this.produtos.map(produto => {
    ...
    async getMatrizABC() {
        ...
        const produtosComClassificacao = produtosOrdenados.map(produto => {
