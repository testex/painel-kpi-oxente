...
router.get('/', asyncHandler(async (req, res) => {
    try {
        const { page = '1', limit = '20', periodo, dataInicio, dataFim, categoria, busca } = req.query;
        const filtros = {
            page: parseInt(page),
...
router.get('/sazonalidade', asyncHandler(async (req, res) => {
    try {
        const periodo = req.query.periodo || 'ano-atual';
...
router.get('/matriz-abc', asyncHandler(async (req, res) => {
    try {
