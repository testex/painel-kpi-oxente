...
class ClientesService {
    ...
    mapERPToCliente(erpCliente) {
        ...
        return {
            ...
            tipoPessoa: erpCliente.tipo_pessoa,
    ...
    async getClientes(filtros = {}) {
        ...
        try {
            ...
            if (filtros.cidade) {
                clientes = clientes.filter(cliente => cliente.enderecos.some(endereco => endereco.cidade.toLowerCase().includes(filtros.cidade.toLowerCase())));
            }
            // Ordenação local
    ...
    async getRFMAnalytics() {
        ...
        try {
            ...
            const clientesRFM = clientes.map(cliente => {
                ...
                if (scoreRFM >= 500)
                    segmento = 'Campeões';
                else if (scoreRFM >= 400)
                    segmento = 'Clientes Leais';
                else if (scoreRFM >= 300)
                    segmento = 'Em Risco';
                else if (scoreRFM >= 200)
